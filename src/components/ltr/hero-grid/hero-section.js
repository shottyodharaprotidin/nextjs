...
import { getFeaturedArticles, getLatestArticles, getStrapiMedia, formatDate } from "@/lib/strapi";
import HomeCenterSlider from "../home-center-slider/home-center-slider";
  ...
  useEffect(() => {
    ...
    async function fetchHeroArticles() {
      try {
        ...
        if (categorySlug) {
             const { getArticlesByCategorySlug } = require("@/lib/strapi");
