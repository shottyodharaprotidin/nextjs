...
import TrendingTopics from "@/components/ltr/trending-topics/trending-topics";
import { getArticleBySlug, getStrapiMedia, formatDate, incrementViewCount, getMostViewedArticles, getPopularArticles, getGlobalSettings } from '@/lib/strapi';
...
const ArticleDetailPage = () => {
  ...
  const adBannerUrl = globalSettings ? getStrapiMedia(globalSettings.adBannerSidebar) : '/assets/images/add320x270-1.jpg';
            ...
            <div className="col-md-4 col-p rightSidebar">
                ...
                <div className="add-inner mb-4">
                  <a href={adBannerLink} target="_blank" rel="noopener noreferrer">
                    <img
                      src={adBannerUrl !== '/default.jpg' ? adBannerUrl : '/assets/images/add320x270-1.jpg'}
                      className="img-fluid"
                      alt="Advertisement"
                    />
                  </a>
